...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="sample_bucket-14")
    bq_project = Variable.get("bq_project", default_var="project-66b66f91-b0f9-40ed-9d0")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"flight-booking-analysis-project/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/flight-booking-analysis-project/spark-job/spark_transformation_job.py",  # Main Python file
